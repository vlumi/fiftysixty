 ...
 * a step to the priced day before and after, a jump to the half hour under way, play through the day at four half
 * hours a second, and a word for where the half hour stands; on today,
 * whether it is now or still ahead, since the price is known before the record.
 */
export default function TimeBar({ date, days, slot, now, playing, onDate, onSlot, onPlay }: Props) {
